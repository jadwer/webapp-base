...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ['@lwm/primitives', '@lwm/ui', '@lwm/auth', '@lwm/app-config', '@lwm/billing', '@lwm/system-health', '@lwm/audit', '@lwm/products', '@lwm/contacts', '@lwm/sales', '@lwm/ecommerce', '@lwm/page-builder', '@lwm/mailer-manager', '@lwm/permissions'],
