 ...
 *
 * SEO 2026-09-18: la metadata vive en page.tsx (server); este archivo es la
 * piel de cliente.
 *
...
export default function CertificadosClient() {
  ...
  return (
    <>
      <CatalogHero title="Certificados y hojas de seguridad (SDS)" subtitle="Consulta los certificados de análisis y hojas de seguridad directamente en el portal de cada fabricante" />
