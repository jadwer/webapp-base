...
export const appSettingsService = {
   ...
   */
  async getPublic(): Promise<{ company: Record<string, AppSettingValue>; branding: Record<string, AppSettingValue>; social: Record<string, AppSettingValue>; pricing: Record<string, AppSettingValue>; landing?: Record<string, AppSettingValue> }> {
