...
export function transformJsonApiProduct(
  ...
  return {
    ...
    satClaveProdServ: (resource.attributes.satClaveProdServ ?? null) as string | null,
    satClaveUnidad: (resource.attributes.satClaveUnidad ?? null) as string | null,
    productType: (resource.attributes.productType ?? null) as Product['productType'],
    taxRate: resource.attributes.taxRate === undefined ? null : (resource.attributes.taxRate as number | null),
    createdAt: (resource.attributes.createdAt || '') as string,
    updatedAt: (resource.attributes.updatedAt || '') as string,
    unit,
    category,
