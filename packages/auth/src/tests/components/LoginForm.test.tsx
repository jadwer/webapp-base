...
// Mock the internal lib/auth path that LoginForm imports directly so the
// LoginForm and the test see the same useAuth instance. Mocking the @lwm/auth
// barrel does not work because LoginForm uses a relative import inside the
// package.
vi.mock('../../lib/auth', () => ({
  useAuth: vi.fn(),
}))
