/**
 * LOCATIONS TABLE
 * Tabla de warehouse locations con sorting, selección y acciones
...
import type { WarehouseLocation, LocationSortOptions, Warehouse } from '../types'
...
export const LocationsTable = memo<LocationsTableProps>(({
  ...
  console.log('🔄 [LocationsTable] Rendering with', locations.length, 'locations')
                ...
                <tr key={location.id}>
                  ...
                  <td>
                    <div className="small">
                      ...
                      {location.maxVolume && (
                        <div><strong>Volume:</strong> {location.maxVolume} m³</div>
                      )}
                      {location.dimensions && (
