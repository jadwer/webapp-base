...
export const CategoriesViewModeSelector = React.memo(() => {
  const { viewMode, setViewMode } = useCategoriesUIStore()
        ...
        <div className="row align-items-center">
          <div className="col">
            <div className="d-flex align-items-center">
              ...
              <h6 className="mb-0 fw-bold">Vista de Categorías</h6>
            </div>
          </div>
          <div className="col-auto">
            <div className="btn-group" role="group" aria-label="Modos de vista de categorías">
...
CategoriesViewModeSelector.displayName = 'CategoriesViewModeSelector'

export default CategoriesViewModeSelector