...
export const ViewModeSelector = React.memo(() => {
  const { viewMode, setViewMode } = useProductsUIStore()
        ...
        <div className="row align-items-center">
          <div className="col">
            <div className="d-flex align-items-center">
              ...
              <h6 className="mb-0 fw-bold">Modo de Vista</h6>
            </div>
          </div>
          <div className="col-auto">
            <div className="btn-group" role="group" aria-label="Modos de vista">
