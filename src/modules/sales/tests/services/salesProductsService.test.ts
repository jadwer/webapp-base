...
describe('salesProductsService', () => {
  ...
  describe('getAll', () => {
    ...
    it('should fetch products with search filter', async () => {
      ...
      // Act
      const result = await salesProductsService.getAll({ 'filter[search]': 'Laptop' })
    ...
    it('should fetch products with includes', async () => {
      ...
      // Act
      const result = await salesProductsService.getAll({ include: 'unit,category' })
    ...
    it('should throw error on API failure', async () => {
      ...
      // Act & Assert
      await expect(salesProductsService.getAll()).rejects.toThrow('Failed to fetch products')
    })
